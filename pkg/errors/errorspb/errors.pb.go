...
func (*EncodedError) Descriptor() ([]byte, []int) {
	return fileDescriptor_errors_07f221745c931295, []int{0}
}
...
func (*EncodedErrorLeaf) Descriptor() ([]byte, []int) {
	return fileDescriptor_errors_07f221745c931295, []int{1}
}
...
func (*EncodedWrapper) Descriptor() ([]byte, []int) {
	return fileDescriptor_errors_07f221745c931295, []int{2}
}
...
func init() {
	proto.RegisterFile("github.com/cockroachdb/cockroach/pkg/errors/errorspb/errors.proto", fileDescriptor_errors_07f221745c931295)
}

var fileDescriptor_errors_07f221745c931295 = []byte{
